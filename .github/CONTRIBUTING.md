...
- **گزارش خطا و پیشنهاد قابلیت:** یک [Issue](https://github.com/bloodworks-io/phlox/issues) باز کنید. مراحل بازتولید، نتیجه مورد انتظار، نتیجه فعلی و محیط اجرا (Windows، برنامه دسکتاپ یا Docker) را بنویسید.
...
- اگر تغییر، مسیرهای صوت/متن بالینی، احراز هویت/CORS یا پایگاه داده را دست می‌زند، در توضیح PR بنویسید چه تهدیدی را پوشش می‌دهید و چگونه آزمایش شده است.
- کلیدهای API، رونوشت‌ها و گزارش‌های بالینی، فایل‌های مدل بزرگ و فایل‌های محیطی شخصی را commit نکنید. برای کلیدهای سرویس‌های برخط از پیکربندی رمزگذاری‌شده برنامه یا secretهای CI استفاده کنید.
