...
const palette = {
    ...
    overlay0: { light: "#626880", dark: "#a2aabf" },
    ...
    invertedText: { light: "#e6e9ef", dark: "#1e2030" },
    primaryButton: { light: "#0c727a", dark: "#8bd5ca" },
    dangerButton: { light: "#c00e34", dark: "#ed8796" },
    successButton: { light: "#246d13", dark: "#a6da95" },
    secondaryButton: { light: "#8a5f00", dark: "#eed49f" },
    neutralButton: { light: "#3f53c2", dark: "#b7bdf8" },
    tertiaryButton: { light: "#a64040", dark: "#f5bde6" },
    chatIcon: { light: "#6d28d9", dark: "#c6a0f6" },
    extraButton: { light: "#a83a8e", dark: "#f5c2e7" },
    border: { light: "#bcc0cc", dark: "#494d64" },
    accent: { light: "#0c727a", dark: "#8bd5ca" },
    ...
    primaryButtonFaint: { light: "#0c727a15", dark: "#8bd5ca15" },
    surfaceQuartile: { light: "#ccd0da40", dark: "#363a4f40" },
    primaryButtonHalftone: { light: "#0c727a80", dark: "#8bd5ca80" },
    sidebarBackgroundFaint: { light: "#23263415", dark: "#1e203015" },
    "buttonBorder.primary": { light: "#085e64", dark: "#76b5ac" },
